...
final class EscaperExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('escape', 'Twig_supTwgSsl_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_supTwgSsl_escape_filter_is_safe']),
            new TwigFilter('e', 'Twig_supTwgSsl_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_supTwgSsl_escape_filter_is_safe']),
            new TwigFilter('raw', 'Twig_supTwgSsl_raw_filter', ['is_safe' => ['all']]),
        ];
    }
...
class_alias('Twig\Extension\EscaperExtension', 'Twig_supTwgSsl_Extension_Escaper');
}
 ...
 * @return string
 */
function Twig_supTwgSsl_raw_filter($string)
{
    return $string;
}
 ...
 * @return string
 */
function Twig_supTwgSsl_escape_filter(Environment $env, $string, $strategy = 'html', $charset = null, $autoescape = false)
{
 ...
 * @internal
 */
function Twig_supTwgSsl_escape_filter_is_safe(Node $filterArgs)
{
