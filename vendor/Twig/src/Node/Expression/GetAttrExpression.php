...
class GetAttrExpression extends AbstractExpression
{
    ...
    public function compile(Compiler $compiler)
    {
        ...
        $compiler->raw('Twig_supTwgSsl_get_attribute($this->env, $this->source, ');
...
class_alias('Twig\Node\Expression\GetAttrExpression', 'Twig_supTwgSsl_Node_Expression_GetAttr');
