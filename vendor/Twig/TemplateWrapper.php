 ...
 */
final class Twig_supTwgSsl_TemplateWrapper
{
    private $env;
    private $template;
     ...
     * directly (use Twig_supTwgSsl_Environment::load() instead).
     *
     * @internal
     */
    public function __construct(Twig_supTwgSsl_Environment $env, Twig_supTwgSsl_Template $template)
    {
        $this->env = $env;
