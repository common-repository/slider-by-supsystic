 ...
 */
class Twig_supTwgSsl_Error extends Exception
{
    protected $lineno;
     ...
     * @param Twig_supTwgSsl_Source|string|null $source   The source context where the error occurred
    ...
    public function __construct($message, $lineno = -1, $source = null, Exception $previous = null)
    {
        if (null === $source) {
            $name = null;
        } elseif (!$source instanceof Twig_supTwgSsl_Source) {
     ...
     *
     * @return Twig_supTwgSsl_Source|null
     */
    public function getSourceContext()
    {
        return $this->filename ? new Twig_supTwgSsl_Source($this->sourceCode, $this->filename, $this->sourcePath) : null;
    }

    /**
     * Sets the source context of the Twig template where the error occurred.
     */
    public function setSourceContext(Twig_supTwgSsl_Source $source = null)
    {
        if (null === $source) {
    ...
    public function __call($method, $arguments)
    {
        ...
        throw new BadMethodCallException(sprintf('Method "Twig_supTwgSsl_Error::%s()" does not exist.', $method));
    }
    ...
    protected function guessTemplateInfo()
    {
        ...
        foreach ($backtrace as $trace) {
            if (isset($trace['object']) && $trace['object'] instanceof Twig_supTwgSsl_Template && 'Twig_supTwgSsl_Template' !== get_class($trace['object'])) {
