 ...
 */
abstract class Twig_supTwgSsl_Test_IntegrationTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * @return string
     */
    ...
    /**
     * @return Twig_supTwgSsl_SimpleFilter[]
     */
    ...
    /**
     * @return Twig_supTwgSsl_SimpleFunction[]
     */
    ...
    /**
     * @return Twig_supTwgSsl_SimpleTest[]
     */
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs)
    {
        ...
        $loader = new Twig_supTwgSsl_Loader_Array($templates);
        ...
        foreach ($outputs as $i => $match) {
            ...
            $twig = new Twig_supTwgSsl_Environment($loader, $config);
            ...
            try {
                ...
                throw new Twig_supTwgSsl_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
            }
            ...
            try {
                ...
                $e = new Twig_supTwgSsl_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
