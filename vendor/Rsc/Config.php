...
class RscSsl_Config extends RscSsl_Common_Collection
{

    /**
     * @var RscSsl_Config_Loader
     */
    protected $loader;

    /**
     * @var RscSsl_Config_ListenerInterface[]
     */
    protected $listener;
    ...
    public function __construct(array $config = array())
    {
        ...
        $this->loader = new RscSsl_Config_Loader();
    }
    ...
    public function load($filename)
    {
        try {
            ...
            return true;
        } catch(RscSsl_Exception_ConfigLoaderException $e) {
            if ($this->isEnvironment(RscSsl_Environment::ENV_DEVELOPMENT)) {
                wp_die ($e->getMessage());
            }
     ...
     * @param RscSsl_Config_ListenerInterface $listener
     * @return RscSsl_Config
     */
    public function addListener($name, RscSsl_Config_ListenerInterface $listener)
    {
    ...
    public function setDefaultPath($defaultPath)
    {
        ...
        $loader->add($defaultPath, RscSsl_Config_Loader::DEFAULT_NAMESPACE);
    }
} 