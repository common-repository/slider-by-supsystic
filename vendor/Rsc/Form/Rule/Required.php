...
class RscSsl_Form_Rule_Required implements RscSsl_Form_Rule_Interface
{
     ...
     * <code>
     *      RscSsl_Form_Rule_Required::create('Control label', $params)->setMessage('The field %s is required');
     * </code>
     * @param string $label Field label
     * @param null $parameters An array of parameters
     * @return RscSsl_Form_Rule_Required
     */
