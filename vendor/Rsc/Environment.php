...
class RscSsl_Environment
{
    ...
    /**
     * @var Twig_supTwgSsl_Environment
     */
    protected $twig;

    /**
     * @var RscSsl_Logger_Interface
     */
    protected $logger;
    ...
    public function __construct($pluginName, $version, $path)
    {
        ...
        /* Class loader */
        $this->loader = new RscSsl_ClassLoader();

        /* Modules resolver */
        $this->resolver = new RscSsl_Resolver($this);

        /* Config */
        $this->config = new RscSsl_Config($this->defaults);
        ...
        /* Dispatcher */
        $this->dispatcher = new RscSsl_Dispatcher($this);
    ...
    public function run()
    {
        ...
        try {
            ...
            $this->twig = new Twig_supTwgSsl_Environment(
                new Twig_supTwgSsl_Loader_Filesystem($templatesPath),
                array(
            ...
            if ($this->isDev()) {
                $this->twig->addExtension(new Twig_supTwgSsl_Extension_Debug());
            }
        ...
        if ($this->config->has('plugin_menu')) {
            $this->menu = new RscSsl_Menu_Page($this->resolver);
        ...
        $this->twig->addGlobal('request', new RscSsl_Http_Request());
...
//        $this->fc320fde997f9bea5c39d56e094bfb99();
     ...
     * @return Twig_supTwgSsl_Environment
     */
    ...
    public function getLang()
    {
        if ($this->lang === null) {
            ...
            $this->lang = new RscSsl_Lang($domain, $path);
        }
    ...
    /**
     * @return \RscSsl_Logger_Interface
     */
    ...
    public function generateUrl($module, $action = 'index', array $parameters = array(), $hash = '')
    {
        ...
        $url .= '&nonce='.wp_create_nonce('ssl_nonce');
            return $url;
     ...
     * @param RscSsl_Cache_Interface $adapter
     * @return RscSsl_Environment
     */
    public function setCacheAdapter(RscSsl_Cache_Interface $adapter)
    {
        $this->cache = new RscSsl_Cache($adapter);
        return $this;
    }
    ...
    {
        $request  = new RscSsl_Http_Request();
    ...
    {
        return RscSsl_Updater::getInstance(
    ...
    {
      return wp_create_nonce('ssl_nonce_frontend');
    }

    public function getNonce()
    {
      return wp_create_nonce('ssl_nonce');
    }
