...
class RscSsl_ClassLoader
{
    ...
    public function find($class)
    {
        ...
        if (stripos($class,'Twig_') !== false) {
           $className = str_replace('Twig_supTwgSsl_', '', $name);
           ...
           if ($class == 'SupsysticSlider_Slider_Twig_supTwgSsl_Attachment') {
           ...
           if ($class == 'SupsysticSliderPro_Slider_Twig_supTwgSsl_Video') {
