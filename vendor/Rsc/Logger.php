...
class RscSsl_Logger implements RscSsl_Logger_Interface
{
     ...
     * @param string $message
     * @param array $context
     * @throws RscSsl_Logger_Exception_InvalidPathException If path is does not exists or does not writable
     * @return null
     */
