...
1.8.10 / 23.01.2024 =
 * Add fix for load new images from media

1.8.9 / 04.12.2023 =
 * Add GDPR option

1.8.8 / 08.11.2023 =
 * Fixes for wordpress.org plugin Team
...
1.8.5 / 08.02.2023 =
 * Fixed issue with image order

1.8.4 / 30.08.2022 =
 * Required min PRO 1.4.13
...
= 1.7.49 / 23.06.2020 =
 * Minor  fixes
 * Change old Twig to Supsystic Universal Twig Twig_supTwgSsl
