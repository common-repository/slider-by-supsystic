 ...
 */
class SupsysticSlider_Core_BaseController extends RscSsl_Mvc_Controller
{

    /**
     * Constructor
     */
    public function __construct(RscSsl_Environment $environment, RscSsl_Http_Request $request)
    {
    ...
    {
        return $this->getEnvironment()->getConfig()->isEnvironment(RscSsl_Environment::ENV_PRODUCTION);
    }
...
//        return $this->getEnvironment()->getModule($module);
     ...
     * @return RscSsl_Mvc_Model|SupsysticSlider_Core_BaseModel
    ...
    public function getModel($modelName)
    {
        ...
        if ($model instanceof RscSsl_Logger_AwareInterface) {
        ...
        if ($model instanceof RscSsl_Environment_AwareInterface) {
    ...
    public function _checkNonce($request){
        ...
        if ( !empty($nonce) && wp_verify_nonce( $nonce, 'ssl_nonce') ) {
           return true;
        }
        return false;
     }
     ...
     public function _checkNonceFrontend($request){
       ...
       if ( !empty($nonce) && wp_verify_nonce( $nonce, 'ssl_nonce_frontend') ) {
          return true;
       }
       return false;
    }
