 ...
 */
class SupsysticSlider_Photos_Module extends RscSsl_Mvc_Module
{
    ...
    public function onInit()
    {
        ...
        add_action('delete_attachment', array(
            new SupsysticSlider_Photos_Model_Photos(
                $config->isEnvironment(RscSsl_Environment::ENV_DEVELOPMENT)
    ...
    public function loadAssets(SupsysticSlider_Ui_Module $ui)
    {
        ...
        $gridGalleryPhotosJs = new SupsysticSlider_Ui_BackendJavascript('gg-uploader-js', $this->getLocationUrl() . '/assets/js/gird-gallery.photos.uploader.js');
        $gridGalleryPhotosJs = $gridGalleryPhotosJs->setInFooter(true);
        $ui->add($gridGalleryPhotosJs);
        $gridGalleryPhotosJs2 = new SupsysticSlider_Ui_BackendJavascript('gg-photos-folders-js', $this->getLocationUrl() . '/assets/js/gird-gallery.photos.folders.js');
        $gridGalleryPhotosJs2 = $gridGalleryPhotosJs2->setInFooter(true);
        $ui->add($gridGalleryPhotosJs);
    }
