...
class SupsysticSlider_Settings_Controller extends SupsysticSlider_Core_BaseController
{
    ...
    {        
        ...
        $validator = new RscSsl_Form_Validator($request, $defaultResponseData['form']['method'], array(
            'cache_ttl' => RscSsl_Form_Rule_Regex::create($lang->translate('Lifetime for cached data'), '/[0-9]+/')
